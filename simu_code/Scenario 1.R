setwd("E:\\WorkSpace\\ScientificResearch\\githubCode\\MMGFM\\simu_code")
...
for(i in 1:N){
  ...
  reslist <- MMGFM(XList, ZList=ZList, numvarmat, q=q, qsvec = qsvec, init='MSFRVI', epsELBO = 1e-20) # LFM
